...
// was asked to highlight the selected link and should staysssssss as welll
...
//                 <NavLink
//                   to={child.path}
//                   className="flex items-center font-serif py-1 text-sm"
//                   activeClassName="text-green-500 dark:text-gray-100"
//                 >
//                   <Route path={child.path} exact={route.exact}>
//                     <span
//                       className={`absolute inset-y-0 left-0 w-1 ${location.pathname === child.path ? 'bg-green-600' : 'bg-transparent'} rounded-tr-lg rounded-br-lg`}
//                       aria-hidden="true"
//                     ></span>
//                   </Route>
//                   <span className="text-xs text-gray-500 pr-1">
//                     <IoRemoveSharp />
//                   </span>
//                   <span className={`text-gray-500 ${location.pathname === child.path ? 'text-green-600' : 'hover:text-green-600 dark:hover:text-gray-200'}`}>
//                     {t(`${child.name}`)}
//                   </span>
//                 </NavLink>
//               </li>
            ...
            {route.routes.map((child, i) => (
              <li key={i + 1}>
                ...
                >
                  <Route path={child.path} exact={route.exact}>
                    <span
                      className={`absolute inset-y-0 left-0 w-1 ${location.pathname === child.path
                        ? 'bg-green-600'
                        : 'bg-transparent'
                  ...
                  <span
                    className={`text-gray-500 ${location.pathname === child.path
                      ? 'text-green-600'
                      : 'hover:text-green-600 dark:hover:text-gray-200'
                      }`}
                  >
                    {t(`${child.name}`)}
                  </span>
